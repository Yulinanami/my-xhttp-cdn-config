...
- `https://REALITY_DOMAIN/sub/TOKEN/mihomo-full.yaml`
- `https://REALITY_DOMAIN/sub/TOKEN/mihomo-nodes.yaml`
...
graph TD
	...
	SUB_NG_STATIC -->|"读取对应配置"| SUB_FILE[("/usr/local/nginx/html/sub/TOKEN/<br/>v2rayn.txt / mihomo-full.yaml / mihomo-nodes.yaml")]
